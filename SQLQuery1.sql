CREATE DATABASE ClinicaMedica           --Criado Banco de Dados
GO

USE ClinicaMedica       -- Entrar no BC que foi criado
GO

CREATE TABLE Pacientes(                  -- Criado a Tabela
	idPaciente INT NOT NULL PRIMARY KEY IDENTITY (1,1),   -- IDENTITY == INCREMENTAR UM POR UM
	Nome VARCHAR(50) NOT NULL,
	Sobrenome VARCHAR(50) NOT NULL,
	CPF NUMERIC NOT NULL UNIQUE,    -- UNIQUE == Ele é único (ele não pode repetir, ele é candidata-chave)
...
CREATE TABLE PacientesParticulares(
	...
	ValorConsulta DECIMAL(8,2) NOT NULL      -- (8,2)  == 8 casas inteiros, e duas decimais
);

-- Alterado a tabela, adicionando o UNIQUE nele
...
ALTER TABLE PacientesParticulares
ADD FOREIGN KEY (idPaciente) REFERENCES Pacientes(idPaciente)  -- FOREIGN == chave estrageira
...
ADD FOREIGN KEY (idEspecialidade) REFERENCES EspecialidadesMedicas(idEspecialidade)